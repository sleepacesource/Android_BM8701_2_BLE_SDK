...
package com.sleepace.sdkdemo.bm8701_2_ble.view.graphview.compatible;
...
public class ScaleGestureDetector {
	...
	public ScaleGestureDetector(Context context,
		...
		try {
			...
			Class<?> classRealScaleGestureDetector = Class.forName(RealScaleGestureDetector.class.getName());
