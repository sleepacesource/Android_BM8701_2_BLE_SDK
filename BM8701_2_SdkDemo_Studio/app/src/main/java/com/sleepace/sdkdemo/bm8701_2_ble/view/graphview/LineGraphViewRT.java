 ...
 */
public class LineGraphViewRT extends GraphView {
	private final Paint paintBackground;
	private boolean drawBackground;
	private boolean drawDataPoints;
	private float dataPointsRadius = 10f;

	public LineGraphViewRT(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public LineGraphViewRT(Context context, String title) {
		super(context, title);
