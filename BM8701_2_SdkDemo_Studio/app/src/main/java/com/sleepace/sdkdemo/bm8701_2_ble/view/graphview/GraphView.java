...
package com.sleepace.sdkdemo.bm8701_2_ble.view.graphview;
...
import com.sleepace.sdkdemo.bm8701_2_ble.view.graphview.compatible.ScaleGestureDetector;
import com.sleepace.sdkdemo.bm8701_2_ble.view.graphview.interfs.CustomLabelFormatter;
import com.sleepace.sdkdemo.bm8701_2_ble.view.graphview.interfs.GraphViewDataInterface;
...
//			LogUtil.log(TAG+" onDraw horlabels:" + Arrays.toString(horlabels)+",graphwidth:" + graphwidth);
			...
			if (graphViewStyle.getGridStyle() != GraphViewStyle.GridStyle.HORIZONTAL) {
				...
				if (end - begin != 0) {
					...
					//int w = (int) paint.measureText(context.getString(R.string.normal));
...
//						canvas.drawText(context.getString(R.string.low), graphwidth + horstart, height - labelTextHeight, paint);
//						canvas.drawText(context.getString(R.string.high), graphwidth + horstart, border , paint);
					}
